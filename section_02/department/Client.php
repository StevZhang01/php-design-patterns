...
class Client
{
    ...
    public function __construct()
    {
        ...
        $Oliva = clone $this->engineer;
        $this->setEmployee($Oliva, 'Oliva Perez', 302, 'op302-1278', 'oliva.png');
        $this->showEmployee($Oliva);

        $John = clone $this->engineer;
        $this->setEmployee($John, 'John Jackson', 301, 'jj301-1454', 'john.png');
